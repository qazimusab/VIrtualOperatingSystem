...
import operating_system.memory.Cache;
import operating_system.main.Converter;
import operating_system.main.Driver;
import operating_system.interfaces.ICPU;
import operating_system.memory.Register;
import operating_system.scheduler.ReadyQueue;
...
public class CPU implements ICPU {
    ...
    public int getEffectiveAddress(int bRegister, long address) {
        return register.retrieve(bRegister) + (int) address;
    }
        ...
        switch (operationCode) {
            case 0:
                ...
                if (address > 0) {
                    ...
                    register.insert(Converter.binaryToDecimal(inputBuffer), register1);
                    totalIOCount++;
                } else {
                    register.insert(register.retrieve(register2), register1);
                    totalIOCount++;
                }
                break;
            case 1:
                ...
                outputBuffer = Converter.decimalToBinary(register.retrieve(register1));
                pcbPosition = readyQueue.getPCBAtFront();
            ...
            case 2:
                ...
                address = register.retrieve(dRegister);
                break;
            case 3:
                ...
                register.insert(register.retrieve((int) address), dRegister);
                System.out.println("Content at Register " + dRegister + " now has value: " + register.retrieve(dRegister));
                break;
            case 4:
                System.out.println("............Operation Code: " + operationCode + " = MOV............");
                register.insert(register.retrieve(register1), register2);
                break;
            case 5:
                System.out.println("............Operation Code: " + operationCode + " = ADD............");
                System.out.println("Adds content of two S-regs into D-reg");
                register.insert(register.retrieve(s1Register) + register.retrieve(s2Register), dRegister);
                System.out.println("Value of Register " + s1Register + ": " + register.retrieve(s1Register));
                System.out.println("Value of Register " + s2Register + ": " + register.retrieve(s2Register));
                System.out.println("Adding value...");
                System.out.println("Value of Register " + dRegister + ": " + register.retrieve(dRegister));
                break;
            case 6:
                System.out.println("............Operation Code: " + operationCode + " = SUB............");
                System.out.println("Subtracts content of two S-regs into D-reg");
                register.insert(register.retrieve(register1) - register.retrieve(register2), dRegister);
                System.out.println("Value of Register " + s1Register + ": " + register.retrieve(s1Register));
                System.out.println("Value of Register " + s2Register + ": " + register.retrieve(s2Register));
            ...
            case 8:
                ...
                if (register.retrieve(s2Register) == 0) {
            ...
            case 11:
                ...
                register.insert(getWordAddress((int) address), dRegister);
                System.out.println("Register " + dRegister + " now has value: " + register.retrieve(dRegister));
                break;
            case 12:
                System.out.println("............Operation Code: " + operationCode + " = ADDI............");
                System.out.println("Adds a Data directly to the content of a register");
                register.insert((int) address + register.retrieve(dRegister), dRegister);
                System.out.println("Register " + dRegister + " now has value: " + register.retrieve(dRegister));
                break;
            case 13:
            ...
            case 14:
                ...
                if (register.retrieve(dRegister) == 0) {
                    System.out.println("Cannot divide by 0!");
                } else {
            ...
            case 15:
                ...
                register.insert((int) address, dRegister);
                System.out.println("Register " + dRegister + " now has value: " + register.retrieve(dRegister));
                break;
            ...
            case 16:
                ...
                if (register.retrieve(s1Register) < register.retrieve(s2Register)) {
                    register.insert(1, dRegister);
                    System.out.println("Value at Register " + dRegister + " = " + register.retrieve(dRegister));
                } else {
                    register.insert(0, dRegister);
                    System.out.println("Value at Register " + dRegister + " = " + register.retrieve(dRegister));
                }
                break;
            case 17:
                ...
                if (register.retrieve(s1Register) < (int) address) {
                    register.insert(1, dRegister);
                    System.out.println("Value at Register " + dRegister + " = " + register.retrieve(dRegister));
                } else {
                    register.insert(0, dRegister);
            ...
            case 21:
                ...
                if (register.retrieve(dRegister) == register.retrieve(bRegister)) {
                    programCounter = (int) address / 4;
            ...
            case 23:
                ...
                if (register.retrieve(bRegister) == 0) {
                    programCounter = (int) address / 4;
                    System.out.println("Program counter set to " + programCounter);
                } else {
                    System.out.println("Program counter set to " + programCounter);
    ...
    public int decode(String binaryInstruction) {
        ...
        switch (instructionType) {
            case 0:
                ...
                System.out.println("Source Register: " + register1 + ": " + register.retrieve(s1Register));
                System.out.println("Source Register: " + register2 + ": " + register.retrieve(s2Register));
                System.out.println("Destination Register: " + dRegister + ": " + register.retrieve(dRegister));
                if (dataSection > 0) {
            ...
            case 1:
                ...
                System.out.println("Operation code: " + opCode);
                System.out.println("Branch Register: " + register.retrieve(bRegister));
                System.out.println("Destination Register: " + register.retrieve(dRegister));
            ...
            case 3:
                ...
                address = Converter.binaryToDecimal(binaryInstruction.substring(16));
                System.out.println("Operation code value: " + opCode);
                System.out.println("Register " + register1 + ": " + register.retrieve(register1));
                System.out.println("Register " + register2 + ": " + register.retrieve(register2));
                System.out.println("Address Value: " + address);
                break;
            default:
